...
function waitForData(){
    if (window.dataLoaded){
        ...
        function createTextWithImage(paragraph){
            ...
            paragraph.forEach(item =>{
                ...
                if (item.image){
                    ...
                    if(item.unique_class){
                        imgContainer.classList.add(`unique_class_${currentPageIndex}`); 
                    }
                    if(item.no_sgn){
                        imgContainer.classList.add('no_sgn');
                    }
                    let imgElement;
        ...
        function updatePage(step){
            ...
            document.querySelector('#control_button_3').style.backgroundColor = "#0072c0";
        };
